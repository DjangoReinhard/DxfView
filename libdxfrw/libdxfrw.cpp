...
bool dxfRW::read(DRW_Interface *interface_, bool ext) {
  ...
  if (interface_ == NULL) return isOk;
...
//do not write linetypes handled by library
  ...
  else writer->writeUtf8Caps(2, ent->name);
...
bool dxfRW::writeLayer(DRW_Layer *ent) {
  ...
  else writer->writeUtf8Caps(6, ent->lineType);
...
bool dxfRW::writeDimstyle(DRW_Dimstyle *ent) {
  ...
  writer->writeInt16(70, ent->flags);
  if (version == DRW::AC1009 || !(ent->dimpost.empty())) writer->writeUtf8String(
      3, ent->dimpost);
  if (version == DRW::AC1009 || !(ent->dimapost.empty())) writer
      ->writeUtf8String(4, ent->dimapost);
  if (version == DRW::AC1009 || !(ent->dimblk.empty())) writer->writeUtf8String(
      5, ent->dimblk);
  if (version == DRW::AC1009 || !(ent->dimblk1.empty())) writer->writeUtf8String(
      6, ent->dimblk1);
  if (version == DRW::AC1009 || !(ent->dimblk2.empty())) writer->writeUtf8String(
      7, ent->dimblk2);
  ...
  if (version > DRW::AC1018 || ent->dimfxl != 0) writer->writeDouble(
      49, ent->dimfxl);
  ...
  if (version > DRW::AC1018 && ent->dimfxlon != 0) writer->writeInt16(
      290, ent->dimfxlon);
  if (version > DRW::AC1009) {
...
bool dxfRW::writePolyline(DRW_Polyline *ent) {
  ...
  writeEntity(ent);
  if (version > DRW::AC1009) {
    if (ent->flags & 8 || ent->flags & 16) writer->writeString(
        100, "AcDb2dPolyline");
    else writer->writeString(100, "AcDb3dPolyline");
  }
  else writer->writeInt16(66, 1);
...
bool dxfRW::writeDimension(DRW_Dimension *ent) {
  if (version > DRW::AC1009) {
    ...
    if (ent->getTextLineStyle() != 1) writer->writeInt16(
        72, ent->getTextLineStyle());
    if (ent->getTextLineFactor() != 1) writer->writeDouble(
        41, ent->getTextLineFactor());
...
//    writer->writeDouble(39, ent->thickness);
  ...
  if (version > DRW::AC1009) writer->writeUtf8String(7, ent->style);
  else writer->writeUtf8Caps(7, ent->style);
...
bool dxfRW::writeBlock(DRW_Block *bk) {
  ...
  else writer->writeUtf8Caps(2, bk->name);
  ...
  if (version > DRW::AC1009) writer->writeUtf8String(3, bk->name);
  else writer->writeUtf8Caps(3, bk->name);
...
//Mandatory linetypes
  ...
  else writer->writeString(2, "BYBLOCK");
  writer->writeInt16(70, 0);
  ...
  else writer->writeString(2, "BYLAYER");
  writer->writeInt16(70, 0);
  writer->writeString(3, "");
  writer->writeInt16(72, 65);
  writer->writeInt16(73, 0);
...
bool dxfRW::writeBlocks() {
  ...
  else writer->writeString(2, "$MODEL_SPACE");
  writer->writeInt16(70, 0);
  writer->writeDouble(10, 0.0);
  writer->writeDouble(20, 0.0);
  writer->writeDouble(30, 0.0);
  if (version > DRW::AC1009) writer->writeString(3, "*Model_Space");
  else writer->writeString(3, "$MODEL_SPACE");
  writer->writeString(1, "");
  writer->writeString(0, "ENDBLK");
  if (version > DRW::AC1009) {
  ...
  else writer->writeString(2, "$PAPER_SPACE");
  writer->writeInt16(70, 0);
  writer->writeDouble(10, 0.0);
  writer->writeDouble(20, 0.0);
  writer->writeDouble(30, 0.0);
  if (version > DRW::AC1009) writer->writeString(3, "*Paper_Space");
  else writer->writeString(3, "$PAPER_SPACE");
  writer->writeString(1, "");
  writer->writeString(0, "ENDBLK");
  if (version > DRW::AC1009) {
...
bool dxfRW::writeExtData(const std::vector<DRW_Variant*> &ed) {
  for (std::vector<DRW_Variant*>::const_iterator it = ed.begin();
    ...
    switch ((*it)->code()) {
      ...
      case 1005: {
        int cc = (*it)->code();
        if ((*it)->type() == DRW_Variant::STRING) writer->writeUtf8String(
            cc, *(*it)->content.s);
//            writer->writeUtf8String((*it)->code, (*it)->content.s);
      ...
      case 1041:
      case 1042:
        if ((*it)->type() == DRW_Variant::DOUBLE) writer->writeDouble(
            (*it)->code(), (*it)->content.d);
        break;
      case 1070:
        if ((*it)->type() == DRW_Variant::INTEGER) writer->writeInt16(
            (*it)->code(), (*it)->content.i);
        break;
      case 1071:
        if ((*it)->type() == DRW_Variant::INTEGER) writer->writeInt32(
            (*it)->code(), (*it)->content.i);
        break;
      default:
        break;
  ...
  while (reader->readRec(&code)) {
    ...
    if (code == 999) {
      ...
      if (sectionstr == "SECTION") {
        ...
        DRW_DBG(code);
        DRW_DBG(" processDxf\n");
        if (!more) return false; //wrong dxf file
        if (code == 2) {
          sectionstr = reader->getString();
          DRW_DBG(sectionstr);
          DRW_DBG("  processDxf\n");
...
bool dxfRW::processEntities(bool isblock) {
  ...
  do {
    if (nextentity == "ENDSEC" || nextentity == "ENDBLK") {
      ...
      else return false; //end of file without ENDSEC
    }
